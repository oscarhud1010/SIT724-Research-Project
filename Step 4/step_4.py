...
IMAGE_PATH = 'images/amazon_image_1.PNG'
...
SIMULATION_TYPE = 'Step 4: See how the LLM rate the Amazon image'
...
def create_batch_prompt(questions_list):
    ...
    prompt = "Answer each of the following bipolar likert-scale questions below for the interface shown. For each question rate the interface from 1 to 7 based on the interface shown.\n"
    prompt += "Pay careful attention to which end of the scale represent the positive/negative response for each individual question before answering.\n\n"
